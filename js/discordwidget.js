...
window.addEventListener('load', () => {
 ...
 //       let width = widget.getAttribute('width') ?? '300px';
...
//        let logo = document.createElement('widget-logo');
        ...
        logo.src = "https://www.8528.space/images/discordlogo.png";
        logo.width = 30;
        ...
        //style
        widget.innerHTML = '<link rel="stylesheet" href="https://8528.space/css/discord.css">';
